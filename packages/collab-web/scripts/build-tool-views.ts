#!/usr/bin/env bun
/**
 * Bundle the shared React tool renderers + the `<yemu-tool-view>` web component
...
const styleInject = css
	? `(()=>{var s=document.createElement("style");s.dataset.yemuToolViews="";s.textContent=${JSON.stringify(css.trim())};(document.head||document.documentElement).appendChild(s);})();\n`
	: "";
