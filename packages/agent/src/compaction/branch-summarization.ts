...
import type { Api, ApiKey, AssistantMessage, Context, Model, SimpleStreamOptions } from "@yemu/model-runtime";
...
export interface GenerateBranchSummaryOptions {
	 ...
	 * wrapped in an OTEL chat span tagged with `yemu.gen_ai.oneshot.kind = "branch_summary"`.
	 */
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from yemu-generated summaries (fromExtension !== true), not extension-generated ones
