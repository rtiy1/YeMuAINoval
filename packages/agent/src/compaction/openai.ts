...
import { applyCodexResponsesLiteShape } from "@yemu/model-runtime/providers/openai-codex/request-transformer";
import {
	createOpenAICodexCompactionRequestContext,
	createOpenAICodexCompatibilityMetadata,
	getCodexAttestationHeader,
} from "@yemu/model-runtime/providers/openai-codex-responses";
import { parseAzureDeploymentNameMap, parseTextSignature } from "@yemu/model-runtime/providers/openai-shared";
import { transformMessages } from "@yemu/model-runtime/providers/transform-messages";
import type {
	Api,
	AssistantMessage,
...
} from "@yemu/model-runtime/utils";
import { captureOpenAIHttpError } from "@yemu/model-runtime/utils/openai-http";
import { $env, isRecord, logger, prompt, stringifyJson, structuredCloneJSON } from "@yemu/utils";
 ...
 * stream (guarded by first-event/idle watchdogs in model-runtime), these are raw
 ...
 * either a purpose-built yemu summarizer (`{systemPrompt, prompt}` → `{summary}`)
 ...
 * issue #4630: without this, the yemu payload was rejected with
