...
import type { HarmonyAuditEvent } from "@yemu/model-runtime/utils/harmony-leak";
...
export class Agent {
	...
	async buildSideRequestContext(
		...
		const ownedDialect = this.#dialect ?? resolveOwnedDialectFromEnv(Bun.env.YEMU_DIALECT);
