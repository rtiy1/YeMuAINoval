...
import type { ProxyAssistantMessageEvent } from "@yemu/agent-core/proxy";
import { type ProxyMessageEventStream, streamProxy } from "@yemu/agent-core/proxy";
import { buildModel } from "@yemu/model-catalog/build";
import type { AssistantMessage, AssistantMessageEvent, Context, FetchImpl, Model, ToolCall } from "@yemu/model-runtime";
import { getStreamingPartialJson } from "@yemu/model-runtime/utils/block-symbols";
