 ...
 * `BlobStore` keep writing to `~/.yemu/agent/...`. Reach for object storage
 * if you need those off-host too.
 */

import { createAgentSession, SessionManager, SqlSessionStorage } from "@yemu/agent-runtime";
import { SQL } from "bun";
...
const storage = await SqlSessionStorage.create({
	client,
	table: "yemu_session_files", // optional, this is the default
