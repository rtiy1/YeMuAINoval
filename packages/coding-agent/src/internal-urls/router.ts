/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `yemu://`, `pr://`, `rule://`, `skill://`, `ssh://`, `vault://`, and `xd://`).
 *
...
import { YemuProtocolHandler } from "./yemu-protocol";
...
export class InternalUrlRouter {
	...
	constructor() {
		this.register(new YemuProtocolHandler());
