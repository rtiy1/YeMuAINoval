 ...
 * isolated directory (`~/.yemu/agent/managed-skills`) separate from
 * user-authored skills (`~/.yemu/agent/skills`). They are discovered and
...
export const MANAGED_SKILLS_PROVIDER_ID = "yemu-managed";
...
/** Resolve the isolated managed-skills directory (`~/.yemu/agent/managed-skills`). */
