 ...
 * `@yemu/utils` (or anything that transitively does). That package's
 ...
 * runtime imports from `@yemu/utils`, which is the whole reason it can
 ...
 */
export const PROFILE_BOOTSTRAP_BOUNDARY_ARG = "--yemu-profile-boundary";
 ...
 * argument — `yemu --print --profile work` still selects a profile) apart from an
 ...
 * a flag's value instead of mistaking it for the subcommand — `yemu --model acp`
