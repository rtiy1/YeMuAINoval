	...
	eval: {
		...
		result: {
			content: [
				{
					type: "text",
					text: ["@yemu/agent-runtime v0.42.0", "37 dependencies"].join("\n"),
				},
			],
			details: {
				language: "python",
				languages: ["python"],
				jsonOutputs: [["@ai-sdk/anthropic", "@yemu/model-runtime", "@yemu/tui"]],
				cells: [
					{
						index: 0,
						title: "load config",
						...
						output: ["@yemu/agent-runtime v0.42.0", "37 dependencies"].join("\n"),
						status: "complete",
						durationMs: 64,
						exitCode: 0,
					},
