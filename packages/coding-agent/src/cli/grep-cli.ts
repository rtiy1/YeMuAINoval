 ...
 *
 * Handles `yemu grep` subcommand for testing grep tool on Windows.
 */
import * as path from "node:path";
import { GrepOutputMode, grep } from "@yemu/native";
...
${chalk.bold("Environment:")}
  YEMU_WALK_WORKERS=N    Set filesystem walker workers (default 4, 0 = auto)
