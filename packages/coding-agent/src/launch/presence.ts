...
import { isEisdir, isEnoent, postmortem } from "@yemu/utils";
import { daemonRuntimeDir } from "./paths";

const CLIENTS_DIR = "clients";

/** Handle keeping one yemu process registered in a project daemon scope. */
...
/** Register this yemu process so project daemons survive while it remains alive. */
...
/** Return whether a registered yemu process in this runtime directory is still alive. */
