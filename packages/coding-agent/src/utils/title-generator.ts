...
import { type Api, type AssistantMessage, completeSimple, type Model } from "@yemu/model-runtime";
import { StreamMarkupHealing } from "@yemu/model-runtime/utils/stream-markup-healing";
import { isTerminalHeadless, logger, prompt } from "@yemu/utils";
...
const TITLE_VISIBILITY_SENTINEL = "\uE000yemu-title-visible\uE000";
