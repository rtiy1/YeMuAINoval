import type { ServiceTier, ServiceTierByFamily, ServiceTierFamily } from "@yemu/model-runtime";
 ...
 * `yemu bench --service-tier` flag, which apply one tier to whatever family the
