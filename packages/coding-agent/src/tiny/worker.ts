...
import { getTinyModelsCacheDir, prompt } from "@yemu/utils";
...
/**
 * Generic single-turn completion used by YeMuMemory memory tasks (fact extraction
 * and consolidation). The caller (YeMuMemory) supplies the full task prompt; we
