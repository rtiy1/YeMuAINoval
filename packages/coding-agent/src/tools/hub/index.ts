...
const hubSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last yemu client exiting; default false"),
	"detached?": type("boolean").describe(
		"start: survive every yemu and broker exit; implies persist and disables PTY input",
	),
