...
import { formatHashlineHeader, stripHashlinePrefixes } from "@yemu/hashline";
import { type Component, Text } from "@yemu/tui";
import { isEnoent, isRecord, prompt, untilAborted } from "@yemu/utils";
...
export class WriteTool implements AgentTool<typeof writeSchema, WriteToolDetails> {
	...
	async execute(
		...
		return untilAborted(signal, async () => {
			...
			// artifacts such as local:// plans are owned by YeMu, not the editor.
