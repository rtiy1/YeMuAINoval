    (function() {
      ...
      const THEME_STORAGE_KEY = 'yemu-export-theme';
      ...
      //  - Share viewer: share-loader.js sets `window.__YEMU_SESSION_DATA__` to
      ...
      const injectedParams = document.querySelector('meta[name="yemu-url-params"]');
      ...
      // ============================================================
      //
      // Tool calls render through the bundled <yemu-tool-view> web component
      ...
      globalThis.__YEMU_TOOL_VIEW_DATA = TOOL_VIEW_DATA;
      let toolViewSeq = 0;
      ...
      function renderToolCall(call, sctx) {
        ...
        return '<yemu-tool-view class="tool-execution ' + statusClass + '" data-key="' + key + '" open></yemu-tool-view>';
      }
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="yemu-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'yemu-share:v1:sidebar-width';
      ...
      const pending = window.__YEMU_SESSION_DATA__;
