 ...
 */
import { type AuthStorage, type FetchImpl, withAuth } from "@yemu/model-runtime";
...
export async function searchWithKagi(
	...
	const response = await withAuth(
		...
		},
		{
			...
			missingKeyMessage: "Kagi credentials not found. Set KAGI_API_KEY or login with 'yemu /login kagi'.",
		},
	);
