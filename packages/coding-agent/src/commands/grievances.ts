...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `yemu grievances` invocation working unchanged
	...
	static examples = [
		"yemu grievances",
		"yemu grievances list --tool find",
		"yemu grievances clean --id 209",
		"yemu grievances clean --tool find",
		"yemu grievances clean --all",
		"yemu grievances push",
	];
