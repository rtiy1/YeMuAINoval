/**
 * `yemu __complete <kind> [-- <prefix>]` — dynamic completion candidates.
 *
 ...
 */
import { type GeneratedProvider, getBundledModels, getBundledProviders } from "@yemu/model-catalog/models";
import { Command } from "@yemu/utils/cli";
