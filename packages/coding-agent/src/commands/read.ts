 ...
 */
import { Args, Command } from "@yemu/utils/cli";
...
export default class Read extends Command {
	...
	static examples = [
		"yemu read src/foo.ts",
		"yemu read src/foo.ts:50-100",
		"yemu read src/foo.ts:raw",
		"yemu read https://example.com",
		"yemu read yemu://",
		"yemu read issue://123",
		"yemu read path/to/archive.zip:dir/file.ts",
		"yemu read path/to/db.sqlite:users:42",
	];
