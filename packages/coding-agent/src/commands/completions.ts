/**
 * `yemu completions <bash|zsh|fish>` — print a shell completion script.
 *
 ...
 */
import { APP_NAME, VERSION } from "@yemu/utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@yemu/utils/cli";
