 ...
 *   - Bundled agents (shipped with yemu-coding-agent)
...
import type { AgentTool, AgentToolResult, AgentToolUpdateCallback } from "@yemu/agent-core";
import type { Usage } from "@yemu/model-runtime";
import { $env, logger, prompt } from "@yemu/utils";
...
export class TaskTool implements AgentTool<TaskToolSchemaInstance, TaskToolDetails, Theme> {
	...
	private constructor(
		...
		this.#blockedAgent = $env.YEMU_BLOCKED_AGENT;
