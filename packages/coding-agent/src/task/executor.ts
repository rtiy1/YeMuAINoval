...
import type { AgentEvent, AgentIdentity, AgentMessage, AgentTelemetryConfig } from "@yemu/agent-core";
import { recordHandoff, resolveTelemetry } from "@yemu/agent-core";
import type { Api, Model, ServiceTierByFamily, Usage } from "@yemu/model-runtime";
import { logger, popLoopPhase, prompt, pushLoopPhase, untilAborted } from "@yemu/utils";
...
export interface ExecutorOptions {
	 ...
	 * `.yemu/tools/` FS scan in the subagent; the subagent then re-binds each
