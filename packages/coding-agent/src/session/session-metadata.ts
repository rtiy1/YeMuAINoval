import { deriveClaudeDeviceId } from "@yemu/model-runtime";
import { getInstallId } from "@yemu/utils";
...
export function buildSessionMetadata(
	...
	if (provider === "anthropic") {
		...
		if (typeof accountUuid === "string" && accountUuid.length > 0) {
			...
			// identifier. Include both yemu's persistent install id and the Claude
