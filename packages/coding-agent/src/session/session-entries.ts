...
import type { ImageContent, MessageAttribution, ServiceTierByFamily, TextContent } from "@yemu/model-runtime";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	/** True if generated by an extension, undefined/false if yemu-generated (backward compatible) */
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if yemu-generated */
	fromExtension?: boolean;
}
...
declare module "@yemu/agent-core/compaction/entries" {
