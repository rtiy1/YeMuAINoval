...
import { invalidateMessageCache, registerMessageCacheInvalidator } from "@yemu/agent-core/compaction/message-cache";
import {
	type BranchSummaryMessage,
	type CompactionSummaryMessage,
	convertMessageToLlm,
} from "@yemu/agent-core/compaction/messages";
import type {
	AssistantMessage,
	ImageContent,
	Message,
...
import { isRecord, logger, prompt } from "@yemu/utils";
...
/** Public input accepted by `yemu.sendMessage` and `AgentSession.sendCustomMessage`. */
...
export const SILENT_ABORT_MARKER = "__yemu.silent_abort__";
...
declare module "@yemu/agent-core" {
