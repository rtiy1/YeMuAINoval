...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@yemu/model-runtime";
...
// Per-provider image-count budgets live in @yemu/compact
...
/**
 * Minimal structural view of a history message — both model-runtime `Message`s (the
