...
const DEFAULT_ENV_DENYLIST = ["YEMU_API_KEY", "YEMU_TOKEN", "YEMU_PASSWORD", "YEMU_SESSION", "YEMU_TOOL_BRIDGE_TOKEN"];
...
const DEFAULT_ENV_ALLOW_PREFIXES = ["LC_", "XDG_", "YEMU_", "JULIA_", "OPENBLAS_", "MKL_"];
