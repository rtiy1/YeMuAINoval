...
import { $env, $which, getPythonEnvDir } from "@yemu/utils";
...
const DEFAULT_ENV_ALLOW_PREFIXES = ["LC_", "XDG_", "YEMU_"];
 ...
 * the managed `~/.yemu/python-env`, then the system interpreter on PATH. Every
