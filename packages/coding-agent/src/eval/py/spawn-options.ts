 ...
 * kernel shares YeMu's session, that shell can replace YeMu as the controlling
 ...
 * redirection cases (`yemu -p > out.txt`, `< in.txt`, `2> err.log`) where at
 ...
 * long-lived YeMu host never changes for the lifetime of the process, and
 ...
 *   of how the standard streams are redirected — so an `yemu -p ... < in.txt
