...
import type { Effort } from "@yemu/model-runtime";
import {
...
import { adjustHsv, colorLuma, getCustomThemesDir, isEnoent, logger, relativeLuminance } from "@yemu/utils";
...
export function getSettingsListTheme(): SettingsListTheme {
	// Plugins (e.g. yemu-rtk-optimizer) may call this before `initTheme()` assigns
