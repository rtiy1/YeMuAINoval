import { type AgentToolResult, ThinkingLevel } from "@yemu/agent-core";
import { PASTE_CODE_LOGIN_PROVIDERS } from "@yemu/model-runtime";
import { getOAuthProviders } from "@yemu/model-runtime/oauth";
import type { OAuthProvider } from "@yemu/model-runtime/oauth/types";
import type { Component, OverlayHandle } from "@yemu/tui";
import { Loader, Spacer, setTuiTight, Text } from "@yemu/tui";
import { getAgentDbPath, getAgentDir, getProjectDir, normalizePathForComparison } from "@yemu/utils";
import {
