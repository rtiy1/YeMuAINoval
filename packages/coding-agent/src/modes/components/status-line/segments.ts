...
import { formatDuration, formatNumber, getProjectDir, pathIsWithin, relativePathWithinRoot } from "@yemu/utils";
...
const yemuSegment: StatusLineSegment = {
	id: "yemu",
	render(ctx) {
		...
		const content = theme.icon.yemu ? `${theme.icon.yemu} ` : "";
