...
import type { CompactionPreparation, CompactionResult } from "@yemu/agent-core/compaction";
import type { AssistantRetryRecovery, ImageContent, TextContent, ToolResultMessage } from "@yemu/model-runtime";
...
export interface SessionStopEventResult {
	...
	continue?: boolean;
	/** YeMu-native model-visible context for the continuation */
