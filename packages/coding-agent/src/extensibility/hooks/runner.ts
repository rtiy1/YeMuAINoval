...
export class HookRunner {
	...
	initialize(options: {
		...
		// Set per-hook handlers for yemu.sendMessage() and yemu.appendEntry()
	 ...
	 *
	 * Note: Messages are already deep-copied by the caller (model-runtime preprocessor).
	 */
	...
	async emitBeforeAgentStart(
		prompt: string,
		images?: import("@yemu/model-runtime").ImageContent[],
