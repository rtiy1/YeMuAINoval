...
/**
 * Send message handler type for yemu.sendMessage().
 */
...
/**
 * Append entry handler type for yemu.appendEntry().
 */
...
export interface LoadedHook {
	...
	/** Set the send message handler for this hook's yemu.sendMessage() */
	setSendMessageHandler: (handler: SendMessageHandler) => void;
	/** Set the append entry handler for this hook's yemu.appendEntry() */
 ...
 * 1. YeMu native configs (.yemu hooks/)
 * 2. Installed plugins
