...
import { HookRunner, type LoadedHook } from "@yemu/agent-runtime/extensibility/hooks";
import { HookToolWrapper } from "@yemu/agent-runtime/extensibility/hooks/tool-wrapper";
...
describe("HookToolWrapper tool_call input override", () => {
	...
	beforeAll(async () => {
		sharedTempDir = TempDir.createSync("@yemu-hook-wrapper-shared-");
