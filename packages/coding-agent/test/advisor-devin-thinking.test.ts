...
// Regression for upstream-change-4579.
//
...
describe("AgentSession advisor descriptor thinking level", () => {
	...
	beforeAll(async () => {
		sharedDir = TempDir.createSync("@yemu-advisor-devin-thinking-shared-");
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@yemu-advisor-devin-thinking-");
