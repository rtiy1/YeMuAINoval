...
import { applyDisabledExtensionsToState } from "@yemu/agent-runtime/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@yemu/agent-runtime/modes/components/extensions/types";
