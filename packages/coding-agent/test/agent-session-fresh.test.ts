...
import { Agent, AppendOnlyContextManager } from "@yemu/agent-core";
...
import type { ProviderSessionState } from "@yemu/model-runtime";
...
async function createFreshHarness(): Promise<FreshHarness> {
	const tempDir = TempDir.createSync("@yemu-agent-session-fresh-");
