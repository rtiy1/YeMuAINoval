 ...
 * The render cache must honor the yemu-tui same-reference contract: unchanged
 * components return the identical array so containers can memoize.
 */

import { beforeAll, describe, expect, it } from "bun:test";
import { createCompactionSummaryMessage } from "@yemu/agent-core/compaction";
import { CompactionSummaryMessageComponent } from "@yemu/agent-runtime/modes/components/compaction-summary-message";
