...
import type { ToolExecutionComponent } from "@yemu/agent-runtime/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@yemu/agent-runtime/task/types";
import type { BashToolDetails } from "@yemu/agent-runtime/tools/bash";
