...
import { SETTINGS_SCHEMA } from "@yemu/agent-runtime/config/settings-schema";
...
beforeEach(async () => {
	...
	delete process.env.WARP_CLI_AGENT_PROTOCOL_VERSION;
	const tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "yemu-abortguard-"));
