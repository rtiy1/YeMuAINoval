...
import type { AsyncJobRegisterOptions } from "@yemu/agent-runtime/async/job-manager";
import { Settings } from "@yemu/agent-runtime/config/settings";
import { resolveLocalRoot } from "@yemu/agent-runtime/internal-urls/local-protocol";
import { TanCommandController } from "@yemu/agent-runtime/modes/controllers/tan-command-controller";
import type { InteractiveModeContext } from "@yemu/agent-runtime/modes/types";
import { AgentRegistry, MAIN_AGENT_ID } from "@yemu/agent-runtime/registry/agent-registry";
...
function createContext(overrides?: {
	...
	const tempDir = TempDir.createSync("@yemu-tan-controller-");
