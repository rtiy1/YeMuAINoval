...
import { Agent, type AgentTool, type AsideMessage } from "@yemu/agent-core";
...
import { TodoTool, type ToolSession } from "@yemu/agent-runtime/tools";
...
describe("AgentSession mid-run todo reconciliation nudge", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@yemu-todo-mid-run-nudge-");
