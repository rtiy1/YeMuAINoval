 ...
 *
 * Regression: see upstream-change-3646. Before the
...
import { EDIT_MODE_STRATEGIES } from "@yemu/agent-runtime/edit/streaming";
...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule, ruleCapability } from "@yemu/agent-runtime/capability/rule";
