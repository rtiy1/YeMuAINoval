...
import { importRoomKey } from "@yemu/agent-runtime/collab/crypto";
...
import { MAX_REPLICATED_PAYLOAD_BYTES, shrinkForReplication } from "@yemu/agent-runtime/collab/replication-shrink";
import type { InteractiveModeContext } from "@yemu/agent-runtime/modes/types";
import type { SessionEntry } from "@yemu/agent-runtime/session/session-entries";
...
/**
 * Single-room relay mirroring the yemu-collab-relay forwarding contract, with
