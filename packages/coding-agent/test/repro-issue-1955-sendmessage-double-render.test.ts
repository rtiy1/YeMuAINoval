...
import { buildSessionContext, type SessionContext } from "@yemu/agent-runtime/session/session-context";
 ...
 *
 * Repro:
 * - Extension calls `yemu.sendMessage({ display: true, ... })` from a
