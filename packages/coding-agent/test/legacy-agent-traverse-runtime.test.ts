...
const probePath = path.resolve(import.meta.dir, "fixtures", "legacy-agent-babel-cache-probe.ts");
const positiveControlPath = path.resolve(import.meta.dir, "fixtures", "legacy-agent-babel-cache-positive-control.ts");
...
describe("legacy YeMu Babel startup closure", () => {
