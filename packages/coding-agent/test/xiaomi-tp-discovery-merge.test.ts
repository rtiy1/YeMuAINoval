...
import { mergeDiscoveredModel } from "@yemu/agent-runtime/config/model-registry";
...
describe("mergeDiscoveredModel", () => {
	...
	test("preserves provider override transport on rediscovery (#2555 openrouter gateway regression)", () => {
		// Bundled openrouter entry carries transport=yemu-native after
		...
		expect(merged.transport).toBe("yemu-native");
