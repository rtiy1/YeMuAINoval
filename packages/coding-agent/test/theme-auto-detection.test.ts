...
import * as nativesModule from "@yemu/native";
import { type MacAppearanceObserver, MacOSAppearance } from "@yemu/native";
import type { Terminal, TerminalAppearance } from "@yemu/tui";
