...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@yemu/agent-runtime/session/messages";
import type { CustomMessageEntry } from "@yemu/agent-runtime/session/session-entries";
