...
import { applyExtensionFlags, type ExtensionFlagSink } from "@yemu/agent-runtime/cli/extension-flags";
import { buildInitialMessage } from "@yemu/agent-runtime/cli/initial-message";
...
import { normalizeContinueSessionArgs } from "@yemu/agent-runtime/main";
