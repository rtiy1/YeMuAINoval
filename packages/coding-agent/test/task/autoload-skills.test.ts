...
import * as skillsModule from "@yemu/agent-runtime/extensibility/skills";
...
import { SKILL_PROMPT_MESSAGE_TYPE } from "@yemu/agent-runtime/session/messages";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult:
			{} as unknown as import("@yemu/agent-runtime/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},
...
describe("autoloadSkills in executor", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@yemu/agent-runtime/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
