...
import type { ToolPathWithSource } from "@yemu/agent-runtime/extensibility/custom-tools";
...
import type { AgentDefinition } from "@yemu/agent-runtime/task/types";
...
describe("runSubprocess parent-discovery pass-through (issue #2190)", () => {
	...
	it("forwards rules, preloadedExtensionPaths, and preloadedCustomToolPaths to createAgentSession", async () => {
		...
		const preloadedExtensionPaths = ["/abs/parent/.yemu/extensions/foo.ts"];
