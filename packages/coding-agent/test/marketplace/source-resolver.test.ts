...
import type { MarketplacePluginEntry } from "@yemu/agent-runtime/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@yemu/agent-runtime/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "yemu-src-res-test-"));
	});
