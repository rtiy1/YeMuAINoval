...
import { isTuiTight, setTuiTight } from "@yemu/tui";
import { getAgentDir, getProjectDir, setAgentDir, setProjectDir } from "@yemu/utils";
...
export function restoreSettingsTestState(state: SettingsTestState | undefined): void {
	...
	restoreEnvValue("YEMU_CODING_AGENT_DIR", state.env.YEMU_CODING_AGENT_DIR);
}
