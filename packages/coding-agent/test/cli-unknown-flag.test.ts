...
import { parseArgs, reportUnrecognizedFlags } from "@yemu/agent-runtime/cli/args";
import { applyExtensionFlags } from "@yemu/agent-runtime/cli/extension-flags";

// Regression coverage for issue #2459: `yemu --list-models` (a stale flag) was
...
describe("parseArgs — unrecognized flag tracking (#2459)", () => {
	...
	it("treats every token after `--` as a positional, even flag-shaped ones (#2461 review)", () => {
		// `yemu -p -- --explain-this` must forward `--explain-this` as the
