...
import { Agent, type AgentTool, ThinkingLevel } from "@yemu/agent-core";
...
import { type Api, Effort, type Model, z } from "@yemu/model-runtime";
...
describe("AgentSession prewalk", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@yemu-prewalk-");
