...
import { getDefault } from "@yemu/agent-runtime/config/settings-schema";
import {
	ReadToolGroupComponent,
	readArgsCollapseIntoGroup,
} from "@yemu/agent-runtime/modes/components/read-tool-group";
...
describe("readArgsCollapseIntoGroup", () => {
	it.each([
		...
		["yemu://docs/tools/read.md"],
		["issue://123"],
		["pr://rtiy1/YeMuAINoval/456"],
		["agent://abc"],
		["artifact://abc"],
		["memory://root"],
		["rule://name"],
