...
import { getTerminalId } from "@yemu/tui";
import { getConfigRootDir, getTerminalSessionsDir, setAgentDir } from "@yemu/utils";
...
describe("SessionManager.continueRecent relocation", () => {
	...
	beforeEach(async () => {
		...
		testAgentDir = await fsp.mkdtemp(path.join(os.tmpdir(), "yemu-reloc-test-"));
