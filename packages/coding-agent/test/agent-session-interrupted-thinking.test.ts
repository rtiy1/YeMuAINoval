...
} from "@yemu/agent-runtime/session/messages";
...
import type { Api, AssistantMessage, Model, ThinkingContent } from "@yemu/model-runtime";
...
describe("AgentSession interrupted thinking persistence", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@yemu-interrupted-thinking-");
