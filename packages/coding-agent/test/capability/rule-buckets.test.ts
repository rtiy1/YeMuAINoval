...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@yemu/agent-runtime/capability/rule";
import { bucketRules } from "@yemu/agent-runtime/capability/rule-buckets";
