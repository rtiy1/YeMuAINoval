...
import type { ExtensionRunner } from "@yemu/agent-runtime/extensibility/extensions/runner";
...
import { type ThinkingContent, z } from "@yemu/model-runtime";
import { createMockModel, type MockModel, type MockResponse } from "@yemu/model-runtime/providers/mock";
...
async function createHarness(
	...
	const tempDir = TempDir.createSync("@yemu-empty-stop-guard-");
