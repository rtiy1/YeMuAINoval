...
import * as autoThinkingClassifier from "@yemu/agent-runtime/auto-thinking/classifier";
...
import { AUTO_THINKING, clampAutoThinkingEffort, resolveProvisionalAutoLevel } from "@yemu/agent-runtime/thinking";
...
describe("AgentSession role model thinking behavior", () => {
	...
	beforeEach(() => {
		tempDir = TempDir.createSync("@yemu-role-thinking-");
	});
