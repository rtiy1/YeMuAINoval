...
import { ExtensionList } from "@yemu/agent-runtime/modes/components/extensions/extension-list";
import type { Extension } from "@yemu/agent-runtime/modes/components/extensions/types";
import { HistorySearchComponent } from "@yemu/agent-runtime/modes/components/history-search";
import { SessionSelectorComponent } from "@yemu/agent-runtime/modes/components/session-selector";
import { TreeSelectorComponent } from "@yemu/agent-runtime/modes/components/tree-selector";
import { UserMessageSelectorComponent } from "@yemu/agent-runtime/modes/components/user-message-selector";
import { initTheme } from "@yemu/agent-runtime/modes/theme/theme";
import { HistoryStorage } from "@yemu/agent-runtime/session/history-storage";
import type { SessionTreeNode } from "@yemu/agent-runtime/session/session-entries";
import type { SessionInfo } from "@yemu/agent-runtime/session/session-listing";
import { setKeybindings } from "@yemu/tui";
...
async function createHistoryStorage(prompts: string[]): Promise<HistoryStorage> {
	const dir = TempDir.createSync("@yemu-history-nav-");
	tempDirs.push(dir);
	HistoryStorage.resetInstance();
