...
import { effectiveReserveTokens, estimateTokens, prepareCompaction } from "@yemu/agent-core/compaction";
...
import { computeNonMessageTokens } from "@yemu/agent-runtime/modes/utils/context-usage";
...
describe("AgentSession snapcompact frame-budget sizing", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@yemu-snapcompact-budget-");
