...
import type { AgentToolCall } from "@yemu/agent-core";
import type { SessionMessageEntry } from "@yemu/agent-core/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@yemu/agent-core/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@yemu/agent-core/compaction/shake";
import type { ProtectedToolContext } from "@yemu/agent-core/compaction/tool-protection";
import { createPlanReadMatcher } from "@yemu/agent-runtime/plan-mode/plan-protection";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@yemu/model-runtime";
