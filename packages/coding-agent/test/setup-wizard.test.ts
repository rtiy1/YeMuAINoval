...
import { runOnboardingSetup } from "@yemu/agent-runtime/commands/setup";
...
import {
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@yemu/agent-runtime/modes/setup-wizard";
import { providersSetupScene } from "@yemu/agent-runtime/modes/setup-wizard/scenes/providers";
import { themeSetupScene } from "@yemu/agent-runtime/modes/setup-wizard/scenes/theme";
import { WebSearchTab } from "@yemu/agent-runtime/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@yemu/agent-runtime/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_ORDER } from "@yemu/agent-runtime/web/search/types";
...
describe("yemu setup onboarding trigger", () => {
