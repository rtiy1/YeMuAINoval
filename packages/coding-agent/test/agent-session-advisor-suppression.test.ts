...
import type { IrcMessage } from "@yemu/agent-runtime/irc/bus";
...
import { USER_INTERRUPT_LABEL } from "@yemu/agent-runtime/session/messages";
...
describe("AgentSession advisor auto-resume suppression", () => {
	...
	beforeEach(() => {
		tempDir = TempDir.createSync("@yemu-advisor-suppress-");
	});
