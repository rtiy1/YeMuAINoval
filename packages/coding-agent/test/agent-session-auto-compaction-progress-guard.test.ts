...
import { resolveThresholdTokens, shouldCompact } from "@yemu/agent-core/compaction";
...
import type { CompactionEntry } from "@yemu/agent-runtime/session/session-entries";
...
describe("AgentSession auto-compaction progress guard", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@yemu-auto-compaction-progress-");
