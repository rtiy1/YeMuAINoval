...
import { Agent, AgentBusyError, ThinkingLevel } from "@yemu/agent-core";
import { KeybindingsManager } from "@yemu/agent-runtime/config/keybindings";
...
import { resolveLocalUrlToPath } from "@yemu/agent-runtime/internal-urls";
import { AssistantMessageComponent } from "@yemu/agent-runtime/modes/components/assistant-message";
import type { HookSelectorSlider } from "@yemu/agent-runtime/modes/components/hook-selector";
import {
	type PlanReviewAnnotationState,
	PlanReviewOverlay,
} from "@yemu/agent-runtime/modes/components/plan-review-overlay";
...
import type { SubmittedUserInput } from "@yemu/agent-runtime/modes/types";
...
import { SILENT_ABORT_MARKER, USER_INTERRUPT_LABEL } from "@yemu/agent-runtime/session/messages";
import { SessionManager } from "@yemu/agent-runtime/session/session-manager";
import { AUTO_THINKING } from "@yemu/agent-runtime/thinking";
import * as clipboard from "@yemu/agent-runtime/utils/clipboard";
import type { AssistantMessage, Usage } from "@yemu/model-runtime";
import * as AIError from "@yemu/model-runtime/error";
import { type OverlayHandle, type OverlayOptions, setKeybindings, Text } from "@yemu/tui";
import { formatNumber, TempDir } from "@yemu/utils";
...
describe("InteractiveMode plan review rendering", () => {
	...
	beforeAll(async () => {
		...
		sharedTempDir = TempDir.createSync("@yemu-plan-review-shared-");
	...
	beforeEach(async () => {
		resetSettingsForTest();
		tempDir = TempDir.createSync("@yemu-plan-review-");
