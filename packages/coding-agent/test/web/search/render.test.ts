...
import { renderSearchResult, type SearchRenderDetails } from "@yemu/agent-runtime/web/search/render";
import type { SearchResponse } from "@yemu/agent-runtime/web/search/types";
