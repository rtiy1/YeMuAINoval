...
import {
	...
	parseDateValue,
	parseSearchQuery,
} from "@yemu/agent-runtime/web/search/query";
import type { SearchSource } from "@yemu/agent-runtime/web/search/types";
...
describe("formatScraperQuery", () => {
	it("demotes path-carrying site: and inurl: to plain terms, keeping bare-domain site:", () => {
		expect(
			formatScraperQuery("site:github.com/rtiy1/YeMuAINoval inurl:releases site:github.com 17.1.1 release"),
		).toBe("17.1.1 release github.com/rtiy1/YeMuAINoval releases site:github.com");
	});
	...
	it("passes directive-free queries through byte-identical", () => {
		expect(formatScraperQuery("github.com/rtiy1/YeMuAINoval 17.1.1 release")).toBe(
			"github.com/rtiy1/YeMuAINoval 17.1.1 release",
		);
	});
