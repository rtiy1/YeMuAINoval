...
import { runStartupSplash } from "@yemu/agent-runtime/modes/setup-wizard/startup-splash";
...
import { shouldShowStartupSplash } from "@yemu/agent-runtime/startup-splash";
