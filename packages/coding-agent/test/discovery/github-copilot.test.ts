...
import { loadCapability, setDisabledProviders } from "@yemu/agent-runtime/capability";
import type { ContextFile } from "@yemu/agent-runtime/capability/context-file";
import { clearCache } from "@yemu/agent-runtime/capability/fs";
import type { Instruction } from "@yemu/agent-runtime/capability/instruction";
import type { Prompt } from "@yemu/agent-runtime/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@yemu/agent-runtime/capability/rule";
import { RuleProtocolHandler } from "@yemu/agent-runtime/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@yemu/utils";
import "@yemu/agent-runtime/capability/context-file";
import "@yemu/agent-runtime/capability/instruction";
import "@yemu/agent-runtime/capability/prompt";
import "@yemu/agent-runtime/capability/rule";
import "@yemu/agent-runtime/discovery/github";
...
describe("github discovery — Copilot user-global surface", () => {
	...
	beforeEach(() => {
		...
		tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "yemu-github-copilot-"));
