...
} from "@yemu/agent-runtime/goals/runtime";
import type { Goal, GoalModeState, GoalRuntimeEvent, GoalTokenUsage } from "@yemu/agent-runtime/goals/state";
import { escapeXmlText } from "@yemu/utils";
