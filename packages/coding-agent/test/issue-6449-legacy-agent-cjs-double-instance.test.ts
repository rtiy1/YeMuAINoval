...
import { ensureGraphCommonJsRequireRegistered } from "@yemu/agent-runtime/extensibility/plugins/legacy-agent-compat";
...
describe("issue #6449: legacy yemu CommonJS graph registration is first-wins", () => {
	...
	// On source-link installs the agent-runtime root shim is served from src/,
	// so an extension import evaluates a SECOND instance of legacy-agent-compat with
