...
import { resizeImage } from "@yemu/agent-runtime/utils/image-resize";
...
describe("resizeImage env wiring", () => {
	...
	it("treats YEMU_NO_WEBP=1 set at call time as exclusion (not baked at module load)", async () => {
		Bun.env.YEMU_NO_WEBP = "1";
