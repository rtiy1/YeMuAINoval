/**
 * Issue #2462: prompt templates discovered from `cwd/.yemu/prompts/` were never
...
import type { PromptTemplate } from "@yemu/agent-runtime/config/prompt-templates";
...
describe("InteractiveMode prompt-template autocomplete (#2462)", () => {
	...
	beforeAll(async () => {
		...
		tempDir = TempDir.createSync("@yemu-prompt-template-autocomplete-");
