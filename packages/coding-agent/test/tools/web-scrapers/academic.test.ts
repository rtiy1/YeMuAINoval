...
import { handleArxiv } from "@yemu/agent-runtime/web/scrapers/arxiv";
import { handleIacr } from "@yemu/agent-runtime/web/scrapers/iacr";
import { handlePubMed } from "@yemu/agent-runtime/web/scrapers/pubmed";
import { handleSemanticScholar } from "@yemu/agent-runtime/web/scrapers/semantic-scholar";
import type { RenderResult } from "@yemu/agent-runtime/web/scrapers/types";
