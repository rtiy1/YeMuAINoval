...
import { handleBiorxiv } from "@yemu/agent-runtime/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@yemu/agent-runtime/web/scrapers/openlibrary";
import { handleWikidata } from "@yemu/agent-runtime/web/scrapers/wikidata";
