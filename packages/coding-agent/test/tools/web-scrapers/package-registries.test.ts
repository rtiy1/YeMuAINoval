...
import { handleCratesIo } from "@yemu/agent-runtime/web/scrapers/crates-io";
import { handleGoPkg } from "@yemu/agent-runtime/web/scrapers/go-pkg";
import { handleHex } from "@yemu/agent-runtime/web/scrapers/hex";
import { handleNpm } from "@yemu/agent-runtime/web/scrapers/npm";
import { handlePubDev } from "@yemu/agent-runtime/web/scrapers/pub-dev";
import { handlePyPI } from "@yemu/agent-runtime/web/scrapers/pypi";
