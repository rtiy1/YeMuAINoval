...
import { handleCheatSh } from "@yemu/agent-runtime/web/scrapers/cheatsh";
import { handleRfc } from "@yemu/agent-runtime/web/scrapers/rfc";
import { handleTldr } from "@yemu/agent-runtime/web/scrapers/tldr";
