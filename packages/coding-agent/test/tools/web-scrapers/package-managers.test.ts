...
import { handleAur } from "@yemu/agent-runtime/web/scrapers/aur";
import { handleBrew } from "@yemu/agent-runtime/web/scrapers/brew";
import { handleMaven } from "@yemu/agent-runtime/web/scrapers/maven";
import { handleNuGet } from "@yemu/agent-runtime/web/scrapers/nuget";
import { handlePackagist } from "@yemu/agent-runtime/web/scrapers/packagist";
import { handleRubyGems } from "@yemu/agent-runtime/web/scrapers/rubygems";
