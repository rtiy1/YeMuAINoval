...
import { handleArtifactHub } from "@yemu/agent-runtime/web/scrapers/artifacthub";
import { handleCoinGecko } from "@yemu/agent-runtime/web/scrapers/coingecko";
import { handleDiscogs } from "@yemu/agent-runtime/web/scrapers/discogs";
