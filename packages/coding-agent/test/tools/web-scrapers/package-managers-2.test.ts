...
import { handleChocolatey } from "@yemu/agent-runtime/web/scrapers/chocolatey";
import { handleDockerHub } from "@yemu/agent-runtime/web/scrapers/dockerhub";
import { handleHackage } from "@yemu/agent-runtime/web/scrapers/hackage";
import { handleMetaCPAN } from "@yemu/agent-runtime/web/scrapers/metacpan";
import { handleRepology } from "@yemu/agent-runtime/web/scrapers/repology";
import { handleTerraform } from "@yemu/agent-runtime/web/scrapers/terraform";
