...
import type { AgentTool, AgentToolContext } from "@yemu/agent-core";
...
import { buildSystemPrompt } from "@yemu/agent-runtime/system-prompt";
import {
	type ComputerParams,
	ComputerTool,
	computerApproval,
	createTools,
	type ToolSession,
} from "@yemu/agent-runtime/tools";
import type {
	ComputerWorkerInbound,
	ComputerWorkerOutbound,
	ComputerWorkerTransport,
} from "@yemu/agent-runtime/tools/computer/protocol";
import {
...
} from "@yemu/agent-runtime/tools/computer/supervisor";
import { ComputerWorkerCore, type NativeDesktopSession } from "@yemu/agent-runtime/tools/computer/worker";
import { computerToolRenderer } from "@yemu/agent-runtime/tools/computer-renderer";
import { buildNamedToolChoice, isToolChoiceActive } from "@yemu/agent-runtime/utils/tool-choice";
import { buildModel } from "@yemu/model-catalog/build";
import type { Api, ComputerAction, ComputerToolCallMetadata, Model } from "@yemu/model-runtime";
import type { DesktopAction, DesktopCapabilities, DesktopCapture, DesktopSessionOptions } from "@yemu/native";
