...
import { Agent, type AgentMessage, type CompactionSummaryMessage, countTokens } from "@yemu/agent-core";
import * as compactionModule from "@yemu/agent-core/compaction";
import { calculateContextTokens, estimateTokens, resolveThresholdTokens } from "@yemu/agent-core/compaction";
...
import { estimateToolSchemaTokens } from "@yemu/agent-runtime/modes/utils/context-usage";
...
import { createMockModel, type MockModel, registerMockApi } from "@yemu/model-runtime/providers/mock";
...
describe("AgentSession advisor context maintenance", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@yemu-advisor-context-maintenance-");
