...
import { estimateTokens } from "@yemu/agent-core/compaction/compaction";
...
import { computeContextBreakdown } from "@yemu/agent-runtime/modes/utils/context-usage";
...
import type { AssistantMessage, Message, Model } from "@yemu/model-runtime";
...
describe("Context usage consolidation", () => {
	...
	beforeAll(async () => {
		sharedDir = TempDir.createSync("@yemu-context-shared-");
