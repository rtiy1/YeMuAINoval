...
import type { StatusLineSettings } from "@yemu/agent-runtime/modes/components/status-line";
...
import type { GitHeadState, GitRefHead, GitRepository } from "@yemu/agent-runtime/utils/git";
