...
// `agent_context_usage` (claude_opus_4_8 observed at 1_000_000), but YeMu's context
...
const ProjectRootNamespaceQuery = `query yemu_gitlabDuoWorkflowProjectRootNamespace($fullPath: ID!) {
...
export function buildGitLabDuoWorkflowModelSpec(
	...
	return {
		...
		// is off — this also hides YeMu's thinking-effort selector for these models.
		reasoning: false,
		input: ["text"],
