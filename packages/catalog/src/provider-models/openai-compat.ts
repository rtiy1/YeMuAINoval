...
/** Cap max output tokens at a value that matches YeMu's other openai-responses defaults. */
...
// of the omitReasoningEffort gate in model-runtime's stream.ts.
