 ...
 * catalog half of what used to live in `@yemu/model-runtime`'s registry definitions
 * (default model, runtime model-manager factory, discovery wiring). The auth
 * half (env keys, OAuth login/refresh) stays in the model-runtime registry, which
