...
import { resolveModelReference } from "@yemu/model-catalog/identity/reference";
import type { ProviderCatalogEntry } from "@yemu/model-catalog/provider-models/descriptor-types";
import {
	CATALOG_PROVIDERS,
	DEFAULT_MODEL_PER_PROVIDER,
	PROVIDER_DESCRIPTORS,
} from "@yemu/model-catalog/provider-models/descriptors";
import {
