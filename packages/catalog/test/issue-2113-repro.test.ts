/**
 * Issue #2113 — `kimik2 does not work on the latest yemu`
 *
...
import { moonshotModelManagerOptions } from "@yemu/model-catalog/provider-models/openai-compat";
import type { Model, ModelSpec } from "@yemu/model-catalog/types";
import {
	type OpenAICompletionsOptions,
	streamOpenAICompletions,
} from "@yemu/model-runtime/providers/openai-completions";
import type { AssistantMessage, Context } from "@yemu/model-runtime/types";
