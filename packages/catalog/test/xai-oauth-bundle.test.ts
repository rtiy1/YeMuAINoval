...
import MODELS_JSON from "@yemu/model-catalog/models.json" with { type: "json" };
import { buildXaiOAuthStaticSeed } from "@yemu/model-catalog/provider-models/openai-compat";
