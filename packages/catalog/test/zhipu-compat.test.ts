...
import { buildOpenAICompat } from "@yemu/model-catalog/compat/openai";
import { DEFAULT_MODEL_PER_PROVIDER } from "@yemu/model-catalog/provider-models";
import { zhipuCodingPlanModelManagerOptions } from "@yemu/model-catalog/provider-models/openai-compat";
import type { FetchImpl, ModelSpec } from "@yemu/model-catalog/types";
