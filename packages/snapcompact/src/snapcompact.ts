 ...
 * code (`renderSnapcompactPng` in `crates/yemu-native/src/snapcompact.rs`).
...
import type { Api, ImageContent, Message, TextContent } from "@yemu/model-runtime";
import { renderSnapcompactPng, snapcompactSupportedChars } from "@yemu/native";
import { formatGroupedPaths, prompt } from "@yemu/utils";
 ...
 * the request, computed for the resolved frame size. Accepts a full model-runtime
 ...
 *  `is_wide` in `crates/yemu-native/src/snapcompact.rs`; the two MUST stay in
