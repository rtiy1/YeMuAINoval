/**
 * Swarm agent execution via yemu-agent's subagent infrastructure.
 *
...
import { runSubprocess } from "@yemu/agent-runtime";
...
/**
 * Execute a single swarm agent as an yemu-agent subagent.
 *
 * The agent receives:
