...
import { COPILOT_API_HEADERS } from "@yemu/model-catalog/wire/github-copilot";
...
import type { Api, Context, Model, ModelSpec } from "@yemu/model-runtime/types";
 ...
 * hint (an yemu-agent extension that preserves native-resolution snapcompact
