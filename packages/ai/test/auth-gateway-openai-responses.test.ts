...
import { encodeResponse, encodeStream, parseRequest } from "@yemu/model-runtime/providers/openai-responses-server";
import { buildResponsesInput } from "@yemu/model-runtime/providers/openai-shared";
import type { AssistantMessage, ModelSpec } from "@yemu/model-runtime/types";
...
describe("openai-responses parseRequest", () => {
	it("parses an input array with mixed message + reasoning + function_call + function_call_output", () => {
		...
		// plumbed through model-runtime — they no longer leak into options.extra.
