...
import { type OpenAIResponsesOptions, streamOpenAIResponses } from "@yemu/model-runtime/providers/openai-responses";
import { buildResponsesInput } from "@yemu/model-runtime/providers/openai-shared";
import type { Context, Model, ModelSpec, ProviderSessionState, Tool } from "@yemu/model-runtime/types";
import { createOpenAIResponsesHistoryPayload, truncateResponseItemId } from "@yemu/model-runtime/utils";
