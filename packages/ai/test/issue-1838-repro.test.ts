 ...
 * `reasoning_content` even though yemu already sends it on the wire (the Kimi
...
import type { AssistantMessage, Context, FetchImpl, Model, ModelSpec } from "@yemu/model-runtime/types";
