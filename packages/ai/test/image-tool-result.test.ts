...
import type { Api, Context, Model, Tool, ToolResultMessage } from "@yemu/model-runtime";
import { complete } from "@yemu/model-runtime";
import type { OptionsForApi } from "@yemu/model-runtime/types";
...
describe("Tool Results with Images", () => {
	...
	describe("Google Antigravity Provider", () => {
		...
		/** These two don't work, the model simply won't call the tool, works in yemu
		it.skipIf(!antigravityToken)(
