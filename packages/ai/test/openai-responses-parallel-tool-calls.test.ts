// Regression for upstream-change-1880.
//
...
import { processResponsesStream } from "@yemu/model-runtime/providers/openai-shared";
import type { AssistantMessage, Model } from "@yemu/model-runtime/types";
