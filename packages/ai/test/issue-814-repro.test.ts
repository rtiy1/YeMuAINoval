...
import type { AssistantMessage, Model, ModelSpec, ToolResultMessage, UserMessage } from "@yemu/model-runtime/types";
 ...
 * carries `tool_use_id`. As a workaround, YeMu must include `id` (aliased to
