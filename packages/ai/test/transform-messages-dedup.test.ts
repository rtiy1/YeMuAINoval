...
import type { AssistantMessage, Message, Model, ToolResultMessage } from "@yemu/model-runtime/types";
import { normalizeResponsesToolCallId } from "@yemu/model-runtime/utils";
