...
import { buildRequest } from "@yemu/model-runtime/providers/google-gemini-cli";
import { convertTools } from "@yemu/model-runtime/providers/google-shared";
import type { Context, Model, TJsonSchema, Tool } from "@yemu/model-runtime/types";
import {
	enforceStrictSchema,
