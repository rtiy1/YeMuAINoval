...
import { AuthStorage, type OAuthCredential, SqliteAuthCredentialStore } from "@yemu/model-runtime";
...
describe("AuthStorage credential block persistence", () => {
	...
	beforeEach(async () => {
		tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "model-runtime-auth-blocks-"));
