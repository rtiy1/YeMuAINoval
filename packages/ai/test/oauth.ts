/**
 * Test helper for resolving API keys from ~/.yemu/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@yemu/model-runtime/oauth";
import type { OAuthCredentials, OAuthProvider } from "@yemu/model-runtime/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@yemu/utils";
...
/**
 * Resolve API key for a provider from ~/.yemu/agent/testauth.db
 *
