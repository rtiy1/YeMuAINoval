...
import type { UsageReport } from "@yemu/model-runtime/usage";
import * as codexUsage from "@yemu/model-runtime/usage/openai-codex";
...
describe("openai-codex workspace-scoped credential identity", () => {
	...
	beforeEach(async () => {
		tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "model-runtime-codex-ws-identity-"));
