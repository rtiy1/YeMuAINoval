 ...
 * that powers `yemu auth-gateway check`. Contract under test:
 *
...
import type { UsageProvider } from "@yemu/model-runtime/usage";
import * as claudeUsage from "@yemu/model-runtime/usage/claude";
import { opencodeGoUsageProvider } from "@yemu/model-runtime/usage/opencode-go";
