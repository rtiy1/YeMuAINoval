...
import type { AssistantMessage, Message, Model, UserMessage } from "@yemu/model-runtime/types";
 ...
 *
 * Reproduces the shape captured in `~/.yemu/logs/http-400-requests/*.json` after Claude
