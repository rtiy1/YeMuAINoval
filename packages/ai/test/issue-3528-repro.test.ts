 ...
 *
 * `yemu-llm-request-15179edfab4dc557.json` plus the rr-session captures from the
 * reporter showed:
 *
 ...
 * thinking output). The YeMu-side `Context` preserved those as a
...
import { renderDemotedThinking } from "@yemu/model-runtime/dialect";
...
describe("llama.cpp warm-prefix preservation (#3528)", () => {
	...
	it("leaves qwenPreserveThinking off for cloud Qwen hosts", () => {
		...
		// cloud side; YeMu isn't responsible for KV-cache invalidation there,
