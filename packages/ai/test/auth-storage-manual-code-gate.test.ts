...
import * as gitlabDuoWorkflowOAuth from "@yemu/model-runtime/registry/oauth/gitlab-duo-workflow";
import type { OAuthLoginCallbacks, OAuthProviderInterface } from "@yemu/model-runtime/registry/oauth/types";
