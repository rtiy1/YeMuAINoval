...
import type { ResponseInput } from "@yemu/model-runtime/providers/openai-responses-wire";
import { buildResponsesInput } from "@yemu/model-runtime/providers/openai-shared";
import type { AssistantMessage, Context, ToolResultMessage, UserMessage } from "@yemu/model-runtime/types";
...
function harmonyPoisonedContext(): { context: Context; user: UserMessage; toolResult: ToolResultMessage } {
	...
	const toolResult: ToolResultMessage = {
		...
		toolName: "grep",
		isError: false,
		content: [{ type: "text", text: `yemu://toolconv/harmony.md: ${MARKER}\nmore docs` }],
		timestamp: 0,
	};
