import type { Dialect as CatalogDialect } from "@yemu/model-catalog/identity";
import type { Context, Message, ToolCall } from "../types";

export type { Dialect } from "@yemu/model-catalog/identity";
...
export interface InbandScannerOptions {
	...
	/** Full tool schemas for schema-driven dialects such as GLM XML and yemu-native. */
