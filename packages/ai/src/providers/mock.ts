...
export class MockModel implements Model<MockApi> {
	...
	/** A streamFn-compatible callable. Forward to `agentLoop` or yemu `stream()`. */
...
/** Stream function for `Model<"mock">`. Matches the model-runtime per-provider stream signature. */
...
export function registerMockApi(sourceId = "model-runtime/mock"): void {
