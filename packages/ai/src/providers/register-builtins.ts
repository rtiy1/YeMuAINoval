 ...
 * vars (`YEMU_STREAM_FIRST_EVENT_TIMEOUT_MS`, `YEMU_STREAM_IDLE_TIMEOUT_MS`) still
 * take precedence unless a provider opts into OpenAI-family idle flooring for
 * local backends that users historically tuned with `YEMU_OPENAI_STREAM_IDLE_TIMEOUT_MS`.
 */
interface LazyStreamLimits {
	 ...
	 * with `YEMU_OPENAI_STREAM_IDLE_TIMEOUT_MS`.
	 */
