...
import { $flag, logger, structuredCloneJSON } from "@yemu/utils";
...
export interface OpenAIResponsesOptions extends StreamOptions {
	 ...
	 * and OFF for other Responses endpoints; `YEMU_OPENAI_STATEFUL` overrides the
...
function isOpenAIResponsesStatefulEnabled(
	...
	return $flag("YEMU_OPENAI_STATEFUL", !baseUrl || hostMatchesUrl(baseUrl, "openai"));
}
