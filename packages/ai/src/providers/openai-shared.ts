...
import { toFirepassWireModelId, toFireworksWireModelId } from "@yemu/model-catalog/fireworks-model-id";
import { isGlm52ReasoningEffortModelId, isKimiK3ModelId } from "@yemu/model-catalog/identity";
...
} from "@yemu/model-catalog/wire/coreweave";
 ...
 * Extends the vendored SDK params with the compat dialect fields model-runtime emits
 ...
 * Built once per request; `apply_patch` → `edit` is the YeMu default.
 */
...
export async function processResponsesStream<TApi extends Api>(
	...
	// see upstream-change-1880 — llama.cpp emits parallel
