 ...
 * gateway. Maps canonical wire variants to our internal normalized yemu Context
 * and options.
 */
...
// `cache_control` is accepted and translated to model-runtime's per-request
...
// preserve per-block breakpoints — model-runtime's anthropic provider re-applies them
