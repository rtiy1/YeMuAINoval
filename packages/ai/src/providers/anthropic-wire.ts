 ...
 *
 * Hand-maintained against https://docs.anthropic.com/en/api/messages so model-runtime
 ...
 *
 * Unlike the SDK, beta fields model-runtime uses (`speed`, `context_management`,
...
/** Web-search server-tool call whose matching result is replayable by yemu. */
...
/** True for the complete native web-search history variants yemu can replay. */
