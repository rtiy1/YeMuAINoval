...
/**
 * Wire types for the yemu auth-gateway.
 *
 * The gateway sits between unauthenticated clients (containerized yemu,
 ...
 * dispatches them through model-runtime's `streamSimple()`, and translates the
