...
const kZodWireSchema = Symbol("yemu.schema.zod.wire");
const kJsonWireSchema = Symbol("yemu.schema.json.wire");
const kArkWireSchema = Symbol("yemu.schema.ark.wire");
const kStrippedSchema = Symbol("yemu.schema.descriptions.stripped");
