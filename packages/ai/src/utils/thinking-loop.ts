 ...
 * through one unguarded pass. Disable detection with `YEMU_NO_THINKING_LOOP_GUARD=1`.
 */
...
>(
	...
	if (process.env.YEMU_NO_THINKING_LOOP_GUARD === "1" || !isLoopGuardedModel(model, options)) {
