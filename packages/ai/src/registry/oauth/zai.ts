...
/** YeMu's own key name so sign-in never mutates ZCode's `zcode-api-key`. */
const KEY_NAME = "yemu-agent";
 ...
 * `getCustomerInfo` → find/create the YeMu-named key → obtain its secret →
