...
import { isProbablyBinary, isProbablyBinaryHeader, isProbablyBinarySync } from "@yemu/utils/binary";
...
describe("isProbablyBinary / isProbablyBinarySync", () => {
	const tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "yemu-binary-"));
