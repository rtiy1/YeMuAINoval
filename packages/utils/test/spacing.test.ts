...
import { getProjectDir, setProjectDir } from "@yemu/utils/dirs";
import { Snowflake } from "@yemu/utils/snowflake";
import { getEditorConfigFormatting } from "@yemu/utils/tab-spacing";
...
describe("getEditorConfigFormatting", () => {
	...
	beforeEach(async () => {
		...
		tempDir = path.join(os.tmpdir(), "yemu-utils-editorconfig-formatting", Snowflake.next());
