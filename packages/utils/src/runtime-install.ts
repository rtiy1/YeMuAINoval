...
const REGISTRY = Symbol.for("yemu.runtimeModuleResolver.registry");
const PATCHED = Symbol.for("yemu.runtimeModuleResolver.patched");
 ...
 * where legacy-agent extensions rely on `createRequire` relative requires.
 */
