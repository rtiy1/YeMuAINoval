...
const candidates: CandidateAddon[] =
	targetArch === "x64"
		? [
				{ variant: "modern", filename: `yemu_natives.${platformTag}-modern.node` },
				{ variant: "baseline", filename: `yemu_natives.${platformTag}-baseline.node` },
			]
		: [{ variant: "default", filename: `yemu_natives.${platformTag}.node` }];
