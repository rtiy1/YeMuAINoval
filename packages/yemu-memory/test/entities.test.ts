...
import {
	...
	similarity,
} from "@yemu/memory/core/entities";
...
describe("entity utilities", () => {
	...
	it("extracts names, phrases, mentions, hashtags, and filters contaminated stop-word phrases", () => {
		const result = extractEntitiesRegex(
			"Abdias said: 'The YeMuMemory project is #Awesome. Contact @support or visit New York.' Maya agreed.",
		);
		...
		expect(result).not.toContain("The YeMuMemory");
	});
