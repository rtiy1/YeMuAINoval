...
describe("multilingual embedding metadata", () => {
	it("detects English, Chinese, multilingual, Jina, and OpenAI dimensions", () => {
		withEnvValue("YEMU_MEMORY_EMBEDDING_DIM", undefined, () => {
	...
	it("allows YEMU_MEMORY_EMBEDDING_DIM to override model dimensions", () => {
		withEnvValue("YEMU_MEMORY_EMBEDDING_DIM", "768", () => {
		...
		withEnvValues(
			{
				...
				YEMU_MEMORY_EMBEDDINGS_VIA_API: undefined,
