...
const SLEEP_BATCH_SIZE = envInt("YEMU_MEMORY_SLEEP_BATCH", 5000);
const TIER2_DAYS = envInt("YEMU_MEMORY_TIER2_DAYS", 30);
const TIER3_DAYS = envInt("YEMU_MEMORY_TIER3_DAYS", 180);
const DEGRADE_BATCH_SIZE = envInt("YEMU_MEMORY_DEGRADE_BATCH", 100);
const TIER3_MAX_CHARS = envInt("YEMU_MEMORY_TIER3_MAX_CHARS", 300);
