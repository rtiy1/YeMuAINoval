...
import { type Component, CURSOR_MARKER, type NativeScrollbackLiveRegion, TUI } from "@yemu/tui";
import { VirtualTerminal } from "./virtual-terminal";

// Regression test for upstream-change-1974
//
...
/**
 * Minimal append-only live region. Models the real yemu setup where
...
describe("issue #1974: tmux scrollback rendering", () => {
	...
	it("does not push chrome below the live block into pane history", async () => {
		// Models a real yemu frame: streamed assistant reply on top, persistent
