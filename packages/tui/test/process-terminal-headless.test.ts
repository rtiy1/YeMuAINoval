...
import { isTerminalHeadless, setTerminalHeadless } from "@yemu/utils";
...
describe("ProcessTerminal headless suppression", () => {
	...
	// #6374: arrows stopped working inside yemu and stayed broken in the shell
	// after exit — a missing cursor-key/keypad reset. yemu owns the TTY and emits
