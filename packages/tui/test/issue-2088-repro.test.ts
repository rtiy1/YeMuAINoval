...
// Regression test for upstream-change-2088
//
...
// path) and YEMU_TUI_RESIZE_IN_PLACE, so neutralize them to keep this
// direct-terminal case deterministic.
NO_MULTIPLEXER_ENV.TERM_PROGRAM = undefined;
NO_MULTIPLEXER_ENV.YEMU_TUI_RESIZE_IN_PLACE = undefined;
