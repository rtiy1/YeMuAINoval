...
import {
	...
	urlTokenPossible,
} from "@yemu/tui/components/markdown";
import { setTerminalTextSizing, TERMINAL } from "@yemu/tui/terminal-capabilities";
import { type Component, TUI } from "@yemu/tui/tui";
...
>bar`,
	...
	describe("Links", () => {
		...
		it("should isolate wrapped OSC 8 links from adjacent table cells", () => {
			const issueUrl = "upstream-change-5860";
			const markdown = new Markdown(
				`| Issue | Title |
|---|---|
