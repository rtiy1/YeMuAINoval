...
import { DEFAULT_TAB_WIDTH } from "@yemu/utils";

export { Ellipsis } from "@yemu/native";

export { DEFAULT_TAB_WIDTH } from "@yemu/utils";
...
// Wire encoding for the native override (see crates/yemu-native text.rs):
...
// crates/yemu-native/src/text.rs, including the rule that the zero-width filler
