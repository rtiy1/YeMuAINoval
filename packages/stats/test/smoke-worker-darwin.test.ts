...
import { smokeTestSyncWorker } from "@yemu/stats/aggregator";
import { installStatsTestIsolation } from "./helpers/temp-agent";

installStatsTestIsolation("@yemu-stats-smoke-darwin-");
...
describe("smokeTestSyncWorker", () => {
	it("skips the worker spawn on darwin so yemu --smoke-test stays off the macOS abort surface", async () => {
