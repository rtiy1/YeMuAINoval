...
import { formatDuration, formatNumber, formatPercent } from "@yemu/utils";
...
async function main(): Promise<void> {
	...
	if (values.help) {
		console.log(`
yemu-stats - AI Usage Statistics Dashboard
...
Examples:
  yemu-stats              # Start dashboard server
  yemu-stats --json       # Print stats as JSON
  yemu-stats --port 8080  # Start on custom port
  yemu-stats --sync       # Sync and show summary
`);
		return;
	}
