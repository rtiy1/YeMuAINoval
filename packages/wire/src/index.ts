/**
 * Shared wire types for the yemu collab live-session protocol.
 *
 * Dependency-free JSON shapes produced by `@yemu/agent-runtime`
...
export const DEFAULT_RELAY_URL = "wss://my.yemu.sh";

/** Default share viewer/upload base; `/share` links resolve against `<base>/<id>#<key>`. */
export const DEFAULT_SHARE_URL = "https://my.yemu.sh/s";
