...
# terminal transcript.
#
# Prepare a directory (default ~/yemu-signing) containing:
...
#   YEMU_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/yemu-signing
...
DIR="${DIR:-${YEMU_SIGNING_DIR:-$HOME/yemu-signing}}"
REPO="${YEMU_REPO:-rtiy1/YeMuAINoval}"
