...
mod tests {
	...
	fn test_wrap_text_with_ansi_apc_in_overflowing_word_terminates() {
		...
		let data = to_u16("\x1b_yemu:c\x07abcdefghijklmnopqrstuvwxyz0123456789");
		...
		assert!(joined.contains("\x1b_yemu:c\x07"));
		for line in &lines {
