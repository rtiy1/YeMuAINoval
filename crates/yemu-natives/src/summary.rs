...
impl From<yemu_ast::summary::SummarySegment> for SummarySegment {
	fn from(value: yemu_ast::summary::SummarySegment) -> Self {
		Self {
			kind:       value.kind,
...
impl From<yemu_ast::summary::SummaryResult> for SummaryResult {
	fn from(value: yemu_ast::summary::SummaryResult) -> Self {
		Self {
...
pub fn summarize_code(options: SummaryOptions) -> Result<SummaryResult> {
	yemu_ast::summary::summarize_code(yemu_ast::summary::SummaryOptions {
		code:               options.code,
		lang:               options.lang,
		path:               options.path,
