//! Batch numeric vector kernels for yemu-memory recall paths.
//!
...
//! `packages/yemu-memory/src/core` exactly — same accumulation order, same
...
/// Cosine similarity with the exact semantics of yemu-memory's TS
