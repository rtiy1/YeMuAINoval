...
This document maps the `@yemu/native` text/search/code surface from generated JS/TS exports to Rust N-API modules and back to JS result objects.

Terminology follows `docs/natives-architecture.md`:

- **Generated binding**: public API in `packages/natives/native/index.d.ts`.
- **Rust module layer**: N-API exports in `crates/yemu-native/src/*`.
...
- `crates/yemu-native/src/glob_util.rs`
- `crates/yemu-native/src/fs_cache.rs`
- `crates/yemu-native/src/fd.rs`
- `crates/yemu-native/src/ast.rs`
- `crates/yemu-native/src/text.rs`
- `crates/yemu-native/src/highlight.rs`
