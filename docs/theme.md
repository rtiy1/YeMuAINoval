...
- syntax highlighting colors used by native highlighter (`@yemu/native`)
...
- default: `~/.yemu/agent/themes`
- overridden by `YEMU_CODING_AGENT_DIR` (`$YEMU_CODING_AGENT_DIR/themes`)
...
- default agent dir: `~/.yemu/agent`
- effective default file: `~/.yemu/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.yemu/agent/themes/my-theme.json`.
