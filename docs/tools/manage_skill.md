...
## Side Effects
- Filesystem: writes or deletes files under `~/.yemu/agent/managed-skills`.
- Network: none.
...
## Notes
- Managed skills are generated under `~/.yemu/agent/managed-skills` and never edit user-authored skills.
