...
| Level   | Path                       | Purpose                     |
| ------- | -------------------------- | --------------------------- |
| Global  | `~/.yemu/agent/secrets.yml` | Secrets across all projects |
| Project | `<cwd>/.yemu/secrets.yml`   | Project-specific secrets    |
