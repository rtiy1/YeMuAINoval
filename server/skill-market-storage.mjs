...
const storageRoot = process.env.STORY_SKILL_MARKET_DIR ? path.resolve(process.env.STORY_SKILL_MARKET_DIR) : defaultRoot;
...
function decodeBase64(value) {
	...
	if (!buffer.length || buffer.length > MAX_SKILL_PACKAGE_BYTES) {
		throw Object.assign(new Error(`Skill 文件大小必须在 1 B 到 ${MAX_SKILL_PACKAGE_BYTES / 1024 / 1024} MB 之间`), {
			status: 400,
		});
	}
	return buffer;
